...
export function ReleaseQuotaBar({ quota, className }: { quota: ReleaseQuota; className?: string }) {
  return (
    <div className={cn(
      'mx-5 mt-3.5 flex shrink-0 items-center justify-between rounded-xl bg-[#f1f2f3] px-3.5 py-[11px]',
      className,
    )}>
